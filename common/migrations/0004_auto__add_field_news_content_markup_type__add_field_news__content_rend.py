...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'News.content_markup_type'
        db.add_column('news', 'content_markup_type',
                      self.gf('django.db.models.fields.CharField')(default='restructuredtext', max_length=30),
                      keep_default=False)

        # Adding field 'News._content_rendered'
        db.add_column('news', '_content_rendered',
                      self.gf('django.db.models.fields.TextField')(default='.'),
                      keep_default=False)


        # Changing field 'News.content'
        db.alter_column('news', 'content', self.gf('markupfield.fields.MarkupField')(rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'News.content_markup_type'
        db.delete_column('news', 'content_markup_type')

        # Deleting field 'News._content_rendered'
        db.delete_column('news', '_content_rendered')


        # Changing field 'News.content'
        db.alter_column('news', 'content', self.gf('django.db.models.fields.TextField')())
