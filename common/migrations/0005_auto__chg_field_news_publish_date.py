...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News.publish_date'
        db.alter_column('news', 'publish_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'News.publish_date'
        db.alter_column('news', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
