...
urlpatterns = [
    ...
    path(
        "/game/<slug:slug>/revisions/<int:pk>",
    ...
    path("/drafts", views.InstallerDraftListView.as_view(), name="api_installer_draft_list"),
    # Issues
    re_path(
        r"/(?P<slug>[\w\-]+)/issues",
    ...
    path(
        "/<slug:game_slug>/issues/<slug:installer_slug>",
    ...
    path(
        "/issue-replies/<int:pk>",
        deprecated.InstallerIssueReplyView.as_view(),
        name="api_installer_issue_reply",
    ),
    # History
    path(
        "/<int:installer_id>/history",
        views.InstallerHistoryView.as_view(),
        name="api_installer_history",
    ),
    path("/history", views.InstallerHistoryListView.as_view(), name="api_installer_history_list"),
    # Generic views
    path("/id/<int:pk>", views.InstallerDetailView.as_view(), name="api_installer_detail"),
    re_path(
        r"/(?P<slug>[\w\-]+)/?",
        views.GameInstallerListView.as_view(),
        name="api_game_installer_list",
    ),
    path("", views.InstallerListView.as_view(), name="api_installer_list"),
]
