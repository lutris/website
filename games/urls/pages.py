...
urlpatterns = [
    ...
    path('<slug:slug>/suggest-changes/',
         views.edit_game,
         name='game-edit'),
    ...
    path('<slug:slug>/installer/fork/',
         ...
         name='fork_installer'),
    path('<slug:slug>/installer/publish/',
         views.publish_installer,
         name='publish_installer'),
    path('<slug:slug>/installer/complete/',
