...
urlpatterns = [
    ...
    path('/library/<username>', views.GameLibraryView.as_view(),
         name='api_game_library'),
    path('/<slug:slug>', views.GameDetailView.as_view(),
         name='api_game_detail'),
    path('/<slug:slug>/installers', views.GameInstallersView.as_view(),
