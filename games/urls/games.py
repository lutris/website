...
urlpatterns = [
    ...
    path(
        "/service/<slug:service>", views.ServiceGameListView.as_view(), name="api_service_game_list"
    ),
    path("/screenshots", views.ScreenshotView.as_view(), name="api_screenshots_list"),
    path(
        "/screenshots/<int:screenshot_id>",
        views.ScreenshotReviewView.as_view(),
        name="api_screenshot_review",
    ),
    ...
    path(
        ...
        views.GameSubmissionAcceptView.as_view(),
        name="api_game_submission_accept",
    ),
    ...
    path(
        "/merge-suggestions", views.GameMergeSuggestionsView.as_view(), name="api_merge_suggestions"
    ),
    path(
        "/merge-suggestions/<int:suggestion_id>",
    ...
    path(
        "/<slug:slug>/merge/<slug:other_slug>", views.GameMergeView.as_view(), name="api_game_merge"
    ),
]
