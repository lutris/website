...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RunnerVersion'
        db.create_table(u'games_runnerversion', (
        ...
        db.send_create_signal(u'games', ['RunnerVersion'])


        # Changing field 'Game.updated'
        db.alter_column(u'games_game', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Game.created'
        db.alter_column(u'games_game', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'RunnerVersion'
        db.delete_table(u'games_runnerversion')


        # Changing field 'Game.updated'
        db.alter_column(u'games_game', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'Game.created'
        db.alter_column(u'games_game', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
