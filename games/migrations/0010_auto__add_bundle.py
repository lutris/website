...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bundle'
        db.create_table(u'games_bundle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'games', ['Bundle'])

        # Adding M2M table for field games on 'Bundle'
        m2m_table_name = db.shorten_name(u'games_bundle_games')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bundle', models.ForeignKey(orm[u'games.bundle'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'games_bundle')

        # Removing M2M table for field games on 'Bundle'
        db.delete_table(db.shorten_name(u'games_bundle_games'))
