...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GameSubmission', fields ['game']
        db.delete_unique(u'games_gamesubmission', ['game_id'])

        # Removing unique constraint on 'GameSubmission', fields ['user']
        db.delete_unique(u'games_gamesubmission', ['user_id'])


        # Changing field 'GameSubmission.user'
        db.alter_column(u'games_gamesubmission', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))

        # Changing field 'GameSubmission.game'
        db.alter_column(u'games_gamesubmission', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Game']))

    def backwards(self, orm):

        # Changing field 'GameSubmission.user'
        db.alter_column(u'games_gamesubmission', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.User'], unique=True))
        # Adding unique constraint on 'GameSubmission', fields ['user']
        db.create_unique(u'games_gamesubmission', ['user_id'])


        # Changing field 'GameSubmission.game'
        db.alter_column(u'games_gamesubmission', 'game_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['games.Game'], unique=True))
        # Adding unique constraint on 'GameSubmission', fields ['game']
        db.create_unique(u'games_gamesubmission', ['game_id'])
    ...
    models = {
        ...
        u'games.gamesubmission': {
            'Meta': {'object_name': 'GameSubmission'},
