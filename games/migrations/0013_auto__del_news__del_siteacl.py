...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'News'
        db.delete_table(u'games_news')

        # Deleting model 'SiteACL'
        db.delete_table(u'games_siteacl')


    def backwards(self, orm):
        # Adding model 'News'
        db.create_table(u'games_news', (
        ...
        db.send_create_signal(u'games', ['News'])

        # Adding model 'SiteACL'
        db.create_table(u'games_siteacl', (
        ...
        db.send_create_signal(u'games', ['SiteACL'])
