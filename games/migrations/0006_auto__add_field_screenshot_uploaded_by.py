...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Screenshot.uploaded_by'
        db.add_column('games_screenshot', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Screenshot.uploaded_by'
        db.delete_column('games_screenshot', 'uploaded_by_id')
