...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.runner'
        db.delete_column('games_game', 'runner_id')

        # Adding M2M table for field platforms on 'Game'
        db.create_table('games_game_platforms', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('game', models.ForeignKey(orm['games.game'], null=False)),
            ('platform', models.ForeignKey(orm['games.platform'], null=False))
        ))
        db.create_unique('games_game_platforms', ['game_id', 'platform_id'])


    def backwards(self, orm):
        # Adding field 'Game.runner'
        db.add_column('games_game', 'runner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Runner'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field platforms on 'Game'
        db.delete_table('games_game_platforms')
