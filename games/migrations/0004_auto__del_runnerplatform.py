...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('games_runner_platforms', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('runner', models.ForeignKey(orm['games.runner'], null=False)),
            ('platform', models.ForeignKey(orm['games.platform'], null=False))
        ))
        db.create_unique('games_runner_platforms', ['runner_id', 'platform_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('games_runner_platforms')
