...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Screenshot.published'
        db.add_column(u'games_screenshot', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Screenshot.published'
        db.delete_column(u'games_screenshot', 'published')
