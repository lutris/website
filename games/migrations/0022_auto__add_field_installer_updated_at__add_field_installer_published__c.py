...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Installer.updated_at'
        db.add_column(u'games_installer', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 7, 10, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Installer.published'
        db.add_column(u'games_installer', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Installer.created_at'
        db.alter_column(u'games_installer', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):
        # Deleting field 'Installer.updated_at'
        db.delete_column(u'games_installer', 'updated_at')

        # Deleting field 'Installer.published'
        db.delete_column(u'games_installer', 'published')


        # Changing field 'Installer.created_at'
        db.alter_column(u'games_installer', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
