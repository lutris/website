...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GameSubmission.updated_at'
        db.delete_column(u'games_gamesubmission', 'updated_at')

        # Adding field 'GameSubmission.accepted_at'
        db.add_column(u'games_gamesubmission', 'accepted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GameSubmission.updated_at'
        db.add_column(u'games_gamesubmission', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 9, 29, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'GameSubmission.accepted_at'
        db.delete_column(u'games_gamesubmission', 'accepted_at')
