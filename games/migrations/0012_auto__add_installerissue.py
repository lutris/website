...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstallerIssue'
        db.create_table(u'games_installerissue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('installer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Installer'])),
            ('submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'games', ['InstallerIssue'])


    def backwards(self, orm):
        # Deleting model 'InstallerIssue'
        db.delete_table(u'games_installerissue')
    ...
    models = {
        ...
        u'games.game': {
            ...
            'platforms': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['platforms.Platform']", 'null': 'True', 'blank': 'True'}),
        ...
        u'games.installerissue': {
            'Meta': {'object_name': 'InstallerIssue'},
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'installer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['games.Installer']"}),
            'submitted_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.User']"})
        },
        u'games.screenshot': {
