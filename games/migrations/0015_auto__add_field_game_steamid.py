...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.steamid'
        db.add_column(u'games_game', 'steamid',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.steamid'
        db.delete_column(u'games_game', 'steamid')
    ...
    models = {
        ...
        u'games.game': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'steamid': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
