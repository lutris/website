...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.cover'
        db.delete_column('games_game', 'cover')


    def backwards(self, orm):
        # Adding field 'Game.cover'
        db.add_column('games_game', 'cover',
                      self.gf('django.db.models.fields.files.ImageField')(default='null.jpg', max_length=100, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'games.game': {
            ...
            'genres': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['games.Genre']", 'null': 'True', 'symmetrical': 'False'}),
            'icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'platforms': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['games.Platform']", 'null': 'True', 'symmetrical': 'False'}),
        ...
        'games.siteacl': {
            ...
            'whitelist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'site_acl'", 'to': "orm['mithril.Whitelist']"})
        },
        'mithril.whitelist': {
