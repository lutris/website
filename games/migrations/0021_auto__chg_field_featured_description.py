...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Featured.description'
        db.alter_column(u'games_featured', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Featured.description'
        db.alter_column(u'games_featured', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
