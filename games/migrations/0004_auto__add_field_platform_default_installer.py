...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Platform.default_installer'
        db.add_column(u'games_platform', 'default_installer',
                      self.gf('jsonfield.fields.JSONField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Platform.default_installer'
        db.delete_column(u'games_platform', 'default_installer')
    ...
    models = {
        ...
        u'games.platform': {
            ...
            'default_installer': ('jsonfield.fields.JSONField', [], {'null': 'True'}),
            'icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '127'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'})
