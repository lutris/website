...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('games_game', 'genre_id')

        # Adding M2M table for field genres on 'Game'
        db.create_table('games_game_genres', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('game', models.ForeignKey(orm['games.game'], null=False)),
            ('genre', models.ForeignKey(orm['games.genre'], null=False))
        ))
        db.create_unique('games_game_genres', ['game_id', 'genre_id'])


    def backwards(self, orm):
        # Adding field 'Game.genre'
        db.add_column('games_game', 'genre',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Genre'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field genres on 'Game'
        db.delete_table('games_game_genres')
    ...
    models = {
        ...
        'games.game': {
            ...
            'genres': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['games.Genre']", 'symmetrical': 'False'}),
