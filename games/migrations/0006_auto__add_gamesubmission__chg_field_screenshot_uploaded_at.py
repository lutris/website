...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameSubmission'
        db.create_table(u'games_gamesubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.User'], unique=True)),
            ('game', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['games.Game'], unique=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'games', ['GameSubmission'])


        # Changing field 'Screenshot.uploaded_at'
        db.alter_column(u'games_screenshot', 'uploaded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'GameSubmission'
        db.delete_table(u'games_gamesubmission')


        # Changing field 'Screenshot.uploaded_at'
        db.alter_column(u'games_screenshot', 'uploaded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'games.gamesubmission': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'game': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['games.Game']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
