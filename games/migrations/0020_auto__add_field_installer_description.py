...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Installer.description'
        db.add_column(u'games_installer', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Installer.description'
        db.delete_column(u'games_installer', 'description')
