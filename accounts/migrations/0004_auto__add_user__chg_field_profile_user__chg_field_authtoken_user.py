...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('steamid', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ...
        db.alter_column(u'accounts_authtoken', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AuthToken.user'
        db.alter_column(u'accounts_authtoken', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
