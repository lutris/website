...
urlpatterns = [
    ...
    path('<username>/library/', views.LibraryList.as_view(),
         name="library_show"),
    path('library/add/<slug:slug>/', views.library_add, name="add_to_library"),
    path('library/remove/<slug:slug>/', views.library_remove,
         name="remove_from_library"),
    path('library/steam-sync/', views.library_steam_sync,
         name="library_steam_sync"),
    path('profile', views.profile, name="profile"),
    path('send-confirmation', views.user_send_confirmation,
         name='user_send_confirmation'),
    path('require-confirmation', views.user_require_confirmation,
