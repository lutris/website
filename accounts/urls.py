...
urlpatterns = [
    ...
    path(
        "password/reset/done",
        views.LutrisPasswordResetDoneView.as_view(),
    ...
    path("<username>/installers/", views.installer_list, name="installer_list"),
    path("library/add/<slug:slug>/", views.library_add, name="add_to_library"),
    path("library/remove/<int:pk>/", views.library_remove, name="remove_from_library"),
